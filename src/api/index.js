...
export default {
  get: function (url, params, headers) {
    return new Promise(function (resolve, reject) {
      return apiAxios('GET', url, headers, params, successRes => {
        resolve(successRes);
      }, failureRes => {
        reject(failureRes);
      })
  ...
  post: function (url, params, headers) {
    return new Promise(function (resolve, reject) {
      return apiAxios('POST', url, headers, params, successRes => {
        resolve(successRes);
      }, failureRes => {
        reject(failureRes);
      })
  ...
  put: function (url, params, headers) {
    return new Promise(function (resolve, reject) {
      return apiAxios('PUT', url, headers, params, successRes => {
        resolve(successRes);
      }, failureRes => {
        reject(failureRes);
      })
  ...
  delete: function (url, params, headers) {
    return new Promise(function (resolve, reject) {
      return apiAxios('DELETE', url, headers, params, successRes => {
        resolve(successRes);
      }, failureRes => {
        reject(failureRes);
      })
